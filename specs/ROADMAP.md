...
### v1.0.0
Goals
- Deliver core to-do list creation, task addition, task status toggle, and list/task viewing UI (MVP).
- Deliver task and list deletion capabilities, polish UI and documentation.
...
- [US-0002] Add a task to a list with a short description
  ...
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-0003] See all lists and tasks with visual completion distinction
  - [x] DRAFT
  - [x] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
