...
- **No persistence requirement beyond session/process** (or file/in-memory as decided by the team).
- **A working web UI is required.**
- **No specific language/framework is mandated.**

## 3. Explicitly Out of Scope
- Multiple users, sharing, permissions.
- Due dates, reminders, priorities, tags, sub-tasks.
- Mobile app, offline support, real-time sync.
