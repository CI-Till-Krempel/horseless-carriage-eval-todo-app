...
- [US-002] Add tasks to a list
  ...
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-003] Mark tasks complete or incomplete
  - [x] DRAFT
  - [x] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
...
- [US-004] Delete tasks and lists
  ...
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-005] List summary view on home page
  - [x] DRAFT
  - [x] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
...
### v1.0.0
Goals
- Deliver the MVP of the To-Do List Web App allowing list and task creation, completion, and deletion with a working web UI.

Stories
- [US-001: Create and view to-do lists] US-001: Create and view to-do lists
  - [ ] DRAFT
  - [ ] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-002: Add tasks to a list] US-002: Add tasks to a list
  - [ ] DRAFT
  - [ ] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-003: Mark tasks complete or incomplete] US-003: Mark tasks complete or incomplete
  - [ ] DRAFT
  - [ ] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-004: Delete tasks and lists] US-004: Delete tasks and lists
  - [ ] DRAFT
  - [ ] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
