...
### v1.0.0
Goals
- Establish product vision, architecture, and core data models for the To-Do List Web App.
...
- [US-0003] Add Task to List
  ...
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-0004] Toggle Task Completion
  - [x] DRAFT
  - [x] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
...
- [US-0006] Delete List
  ...
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-0007] View Lists and Tasks Overview
  - [x] DRAFT
  - [x] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
