...
### v1.0.0
Goals
- Deliver core To-Do List Web App MVP across 5 sprints
...
- [US-002] Add tasks to a list
  ...
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-003] Mark tasks as complete or incomplete
  - [ ] DRAFT
  - [ ] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-004] Delete tasks and entire lists
  - [ ] DRAFT
  - [ ] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
  - [ ] TESTED
  - [ ] ACCEPTED
- [US-005] Polish UI and verify end-to-end functionality
  - [ ] DRAFT
  - [ ] READY
  - [ ] IMPLEMENTED
  - [ ] REVIEWED
