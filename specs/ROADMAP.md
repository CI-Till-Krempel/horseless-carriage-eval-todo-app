...
### Sprint 1
Goals
- Establish core to-do list application skeleton, backend state, and web UI supporting creation, tasks, completion toggles, deletion, and visual differentiation.

Stories
- [ ] [US-006] View Lists and Tasks with Visual Distinction
